...
public:
	TempFileMetadata() : file_index(0), block_size(0), nr_blocks(0) {
	}
...
public:
	...
	// For cache file support - rename metadata entry
	void RenameFile(const string &old_name, const string &new_name);

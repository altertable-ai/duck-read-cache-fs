...
void ResetGlobalStateAndConfig() {
	// No-op: With per-instance state, each DuckDB instance has its own
	// isolated configuration and cache state. Tests should create fresh
	// DuckDB instances for clean state.
}
